...
const STORAGE_KEY = "blinkai_settings";
      ...
      <main className="max-w-3xl mx-auto px-4 sm:px-6 py-8 space-y-8">
        ...
        <section className="rounded-xl border border-border bg-card p-6">
          <div className="flex items-center gap-2 mb-4">
            ...
            <h2 className="text-base font-semibold">About BlinkAI</h2>
          </div>
          <div className="space-y-2 text-sm text-muted-foreground">
            <p>BlinkAI is an AI-powered web application builder.</p>
            <p>
              Describe the app you want and BlinkAI generates complete, working HTML/CSS/JS that
