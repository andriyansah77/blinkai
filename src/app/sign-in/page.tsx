...
import { Loader2, Sparkles, Shield, Zap, Wallet } from 'lucide-react';
    ...
    <div className="min-h-screen bg-[#0a0a0a] text-white flex items-center justify-center p-4">
      <div className="w-full max-w-md">
        ...
        >
          ...
          <h1 className="text-3xl font-bold mb-2">Welcome to ReAgent</h1>
          <p className="text-gray-400">Sign in to deploy AI agents on blockchain</p>
        </motion.div>
        ...
        >
          ...
          <div className="mt-6 space-y-3">
            <div className="flex items-center gap-3 text-sm text-gray-400">
              ...
              <span>Connect with MetaMask, WalletConnect, or any wallet</span>
            </div>
            <div className="flex items-center gap-3 text-sm text-gray-400">
              <Zap className="w-4 h-4 text-orange-400" />
              <span>Or sign in with Google, Twitter, Discord</span>
            </div>
            <div className="flex items-center gap-3 text-sm text-gray-400">
              <Shield className="w-4 h-4 text-orange-400" />
              <span>Embedded wallet auto-created if needed</span>
            </div>
          </div>
        </motion.div>
